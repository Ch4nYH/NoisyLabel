...
def main():
    ...
    for epoch in range(args.epochs):
        train(model, input_channel, optimizers, ['fc', 'backbone'], criterion, train_loader, val_loader, epoch, writer, args, use_CUDA = use_CUDA, clamp = args.clamp, num_classes = args.num_classes)
